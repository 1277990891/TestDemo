...
- (void)viewDidLoad
{
    ...
    CGFloat marginLeft = 25;  //订阅项目与边缘的距离
    ...
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake((kScreenWidth-100)/2, 25, 100, 40)];
    ...
    _titleLabel2 = [[UILabel alloc] initWithFrame:CGRectMake((kScreenWidth-100)/2, KTableStartPointY + height_item * [self row_order_YES_count] + 10, 100, 20)];
