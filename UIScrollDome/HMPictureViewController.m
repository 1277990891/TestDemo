//
//  HMPictureViewControllerTableViewController.m
//  UIScrollDome
//
...
#define picWeight 90
@interface HMPictureViewController ()
{
    NSArray *_urls;
}
@end

@implementation HMPictureViewController
...
- (void)viewDidLoad {
    ...
    CGFloat width = picWeight;
    CGFloat height = picWeight;
    CGFloat margin = 20;
